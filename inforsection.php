        ...
        <div class="header">
            ...
            <div>
                <form action="#>" method="post">
                    ...
                    <form>
                        <a href='index.php?Menu=1&Submenu=createsection'><button type="button" class="button1">เพิ่มข้อมูลหัวข้องานบริการ/วิจัย <i class='fas fa-plus-circle' style='font-size:16px'></i></button></a>
                    </form>
                </form>
                                    ...
                                    <div class="modal-body">
                                        <table class="table table-borderless">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-right">หัวข้อของงานบริการ/วิจัย</td>
                                                    <td><input class="form-control" placeholder="สมมติ"></td>
                                                </tr>
                                                <tr>
