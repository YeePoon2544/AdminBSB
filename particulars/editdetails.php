...
<head>
    <meta charset="utf-8">
    <title>แก้ไขรายละเอียดของงาน</title>
                        ...
                        <div class="body">
                            <div>
                                ...
                                <form action="#" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" method="POST" enctype="multipart/form-data">
                                    <h2 class="w3-center">ฟอร์มแก้ไขข้อมูลรายละเอียดบริการ/วิจัย</h2>
                                    ...
                                    <h5>รายละเอียดของงานบริการ/วิจัย</h5>
                                    <div class="w3-row w3-section">
                                        <div class="w3-col" style="width:50px"><i class='far fa-file' style='font-size:36px'></i></div>
                                        <div class="w3-rest">
                                            <textarea name="story" cols="105" rows="10" placeholder="รายละเอียด"></textarea>
                                        </div>
                                    </div>
